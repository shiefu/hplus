...
<head>
    ...
    <link rel="shortcut icon" href="<?=ADMIN_ASSETS_DIR?>/favicon.ico">
...
<div class="row  border-bottom white-bg dashboard-header">
    ...
    <div class="col-sm-3">
        ...
        <br>
        <br>
        <img src="<?=ADMIN_ASSETS_DIR?>/img/qr_code.png" width="100%" style="max-width:264px;">
        <br>
    </div>
    <div class="col-sm-5">
        <h2>
...
<script src="<?=ADMIN_ASSETS_DIR?>/js/content.min.js"></script>
<script src="<?=ADMIN_ASSETS_DIR?>/js/welcome.min.js"></script>
</body>
</html>
